#!/usr/bin/env python3
"""Stage 2: train ACP-ProtFusion for five-label cancer-type prediction."""
...
from acp_protfusion.config import CANCER_TYPES, ExperimentConfig
from acp_protfusion.data import (
    MultiLabelPeptideDataset,
    augment_cervical_positives,
    conditional_cooccurrence,
    make_folds,
)
from acp_protfusion.losses import GradNormBalancer, asymmetric_loss_per_label
from acp_protfusion.metrics import best_youden_thresholds, multilabel_metrics, selection_score
from acp_protfusion.model import ACPProtFusion, load_stage1_encoder, load_tokenizer
