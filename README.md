...
│   ├── model.py        # attention pool, Stage 1 model, and ACP-ProtFusion
...
Across the five fold-trained models evaluated on the same independent test set, ACP-ProtFusion achieved a macro-F1 of **68.89 ± 1.94%**. Cancer-type F1 values were 78.52 ± 1.46% (breast), 76.53 ± 5.34% (lung), 74.19 ± 1.52% (colon), 47.38 ± 7.73% (cervical), and 67.83 ± 2.47% (skin).

![Independent-test comparison](assets/model_comparison.png)

![Component ablation](assets/ablation.png)
...
If you use this repository, please cite the ACP-ProtFusion manuscript. The final journal citation and DOI will be added after publication.
